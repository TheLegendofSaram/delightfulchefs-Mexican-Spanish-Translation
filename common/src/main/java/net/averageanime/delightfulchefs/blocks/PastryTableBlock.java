...
public class PastryTableBlock extends TableBlock {

    public PastryTableBlock(Settings settings) {
        super(settings);
    }
    ...
    public static VoxelShape TABLE_SHAPE = VoxelShapes.union(
            ...
            VoxelShapes.cuboid(0, 0.875, 0.0625, 0.0625, 1, 0.9375),
            ...
            VoxelShapes.cuboid(0.25, 0.3125, 0.6875, 0.75, 0.375, 0.75),
            VoxelShapes.cuboid(0.75, 0.3125, 0.1875, 0.8125, 0.375, 0.6875),
            VoxelShapes.cuboid(0, 0.8125, 0.0625, 1, 0.875, 0.9375),
            VoxelShapes.cuboid(0.9375, 0.875, 0.0625, 1, 1, 0.9375),
            VoxelShapes.cuboid(0, 0.875, 0, 1, 1, 0.0625),
