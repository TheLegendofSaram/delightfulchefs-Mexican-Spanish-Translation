...
public class SousTableBlock extends TableBlock {

    public SousTableBlock(Settings settings) {
        super(settings);
    }
    ...
    public static VoxelShape TABLE_SHAPE = VoxelShapes.union(
            ...
            VoxelShapes.cuboid(0, 0.8125, 0, 1, 1.0625, 0.0625),
            ...
            VoxelShapes.cuboid(0.125, 0, 0.625, 0.25, 0.875, 0.75),
            VoxelShapes.cuboid(0.75, 0, 0.0625, 0.875, 0.875, 0.1875),
            VoxelShapes.cuboid(0.125, 0, 0.0625, 0.25, 0.875, 0.1875),
            VoxelShapes.cuboid(0.75, 0, 0.625, 0.875, 0.875, 0.75),
            VoxelShapes.cuboid(0, 0.8125, 0, 1, 0.875, 0.875),
            VoxelShapes.cuboid(0.25, 0.25, 0.125, 0.75, 0.3125, 0.6875),
            VoxelShapes.cuboid(0.25, 0.1875, 0.6875, 0.75, 0.3125, 0.75),
            VoxelShapes.cuboid(0.75, 0.1875, 0.1875, 0.8125, 0.3125, 0.6875),
            VoxelShapes.cuboid(0.25, 0.1875, 0.125, 0.3125, 0.3125, 0.6875),
            VoxelShapes.cuboid(0.6875, 0.1875, 0.125, 0.75, 0.3125, 0.6875),
            VoxelShapes.cuboid(0.25, 0.1875, 0.0625, 0.75, 0.3125, 0.125),
            VoxelShapes.cuboid(0.1875, 0.1875, 0.125, 0.25, 0.3125, 0.625)
