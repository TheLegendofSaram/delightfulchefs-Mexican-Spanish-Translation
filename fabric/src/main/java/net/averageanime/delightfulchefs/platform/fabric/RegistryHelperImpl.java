...
public class RegistryHelperImpl {
    ...
    public static <T extends Block> Supplier<T> registerBlock(String name, Supplier<T> block) {
        var registry = Registry.register(Registries.BLOCK, new Identifier(DelightfulChefs.MOD_ID, name), block.get());
        return () -> registry;
    }

    public static <T extends Item> Supplier<T> registerItem(String name, Supplier<T> item) {
        var registry = Registry.register(Registries.ITEM, new Identifier(DelightfulChefs.MOD_ID, name), item.get());
        return () -> registry;
    }
    ...
    public static void registerItemGroup(RegistryKey<ItemGroup> registryKey, String name, String literalName, Supplier<Item> item) {
        Registry.register(Registries.ITEM_GROUP, registryKey,
                FabricItemGroup.builder()
                        .displayName(Text.translatable("itemGroup.delightfulchefs.group"))
    ...
    public static <T extends BlockEntityType<?>> Supplier<T> registerBlockEntity(String name, Supplier<T> blockEntity) {
        var registry = Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(DelightfulChefs.MOD_ID, name), blockEntity.get());
        return () -> registry;
    }

    public static void registerParticleType(String name, DefaultParticleType particleType) {
        Registry.register(Registries.PARTICLE_TYPE, DelightfulChefs.createStringID(name), particleType);
    }


    public static void registerScreenHandlerType(String name, ScreenHandlerType<?> screenHandlerType) {
        Registry.register(Registries.SCREEN_HANDLER, new Identifier(DelightfulChefs.MOD_ID, name), screenHandlerType);
    }
    ...
    public static <T extends SoundEvent> Supplier<T> registerSoundEvent(String name, Supplier<T> soundEvent) {
        var registry = Registry.register(Registries.SOUND_EVENT, new Identifier(DelightfulChefs.MOD_ID, name), soundEvent.get());
        return () -> registry;
    }
    ...
    public static <T extends PointOfInterestType> Supplier<T> registerPointOfInterestType(String name, Supplier<T> pointOfInterestType) {
        var registry = Registry.register(Registries.POINT_OF_INTEREST_TYPE, new Identifier(DelightfulChefs.MOD_ID, name), pointOfInterestType.get());
        return () -> registry;
    }
    ...
    public static <T extends VillagerProfession> Supplier<T> registerVillagerProfession(String name, Supplier<T> villagerProfession) {
        var registry = Registry.register(Registries.VILLAGER_PROFESSION, new Identifier(DelightfulChefs.MOD_ID, name), villagerProfession.get());
        return () -> registry;
    }
