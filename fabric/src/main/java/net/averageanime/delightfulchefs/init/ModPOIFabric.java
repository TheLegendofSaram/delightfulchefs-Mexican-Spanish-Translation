...
public class ModPOIFabric {
    ...
    public final static Supplier<PointOfInterestType> CUSTOMER_TABLE_POI;
    ...
    static {
        ...
        CUSTOMER_TABLE_POI = registerPointOfInterest("customer_table", () -> new PointOfInterestType(PointOfInterestTypes.getStatesOfBlock(SERVING_TABLE_BLOCK.get()), 1, 1));
        ...
        VENDOR_ACACIA_POI = registerPointOfInterest("vendor_acacia_poi", () -> new PointOfInterestType(PointOfInterestTypes.getStatesOfBlock(ModBlocks.ACACIA_CABINET.get()), 1, 1));
        VENDOR_BAMBOO_POI = registerPointOfInterest("vendor_bamboo_poi", () -> new PointOfInterestType(PointOfInterestTypes.getStatesOfBlock(ModBlocks.BAMBOO_CABINET.get()), 1, 1));
        VENDOR_BIRCH_POI = registerPointOfInterest("vendor_birch_poi", () -> new PointOfInterestType(PointOfInterestTypes.getStatesOfBlock(ModBlocks.BIRCH_CABINET.get()), 1, 1));
        VENDOR_CHERRY_POI = registerPointOfInterest("vendor_cherry_poi", () -> new PointOfInterestType(PointOfInterestTypes.getStatesOfBlock(ModBlocks.CHERRY_CABINET.get()), 1, 1));
        VENDOR_CRIMSON_POI = registerPointOfInterest("vendor_crimson_poi", () -> new PointOfInterestType(PointOfInterestTypes.getStatesOfBlock(ModBlocks.CRIMSON_CABINET.get()), 1, 1));
        VENDOR_DARK_OAK_POI = registerPointOfInterest("vendor_dark_oak_poi", () -> new PointOfInterestType(PointOfInterestTypes.getStatesOfBlock(ModBlocks.DARK_OAK_CABINET.get()), 1, 1));
        VENDOR_JUNGLE_POI = registerPointOfInterest("vendor_jungle_poi", () -> new PointOfInterestType(PointOfInterestTypes.getStatesOfBlock(ModBlocks.JUNGLE_CABINET.get()), 1, 1));
        VENDOR_MANGROVE_POI = registerPointOfInterest("vendor_mangrove_poi", () -> new PointOfInterestType(PointOfInterestTypes.getStatesOfBlock(ModBlocks.MANGROVE_CABINET.get()), 1, 1));
        VENDOR_OAK_POI = registerPointOfInterest("vendor_oak_poi", () -> new PointOfInterestType(PointOfInterestTypes.getStatesOfBlock(ModBlocks.OAK_CABINET.get()), 1, 1));
        VENDOR_SPRUCE_POI = registerPointOfInterest("vendor_spruce_poi", () -> new PointOfInterestType(PointOfInterestTypes.getStatesOfBlock(ModBlocks.SPRUCE_CABINET.get()), 1, 1));
        VENDOR_WARPED_POI = registerPointOfInterest("vendor_warped_poi", () -> new PointOfInterestType(PointOfInterestTypes.getStatesOfBlock(ModBlocks.WARPED_CABINET.get()), 1, 1));
